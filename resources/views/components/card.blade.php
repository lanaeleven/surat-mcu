{{-- <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="{{ $href }}">
        <img class="rounded-t-lg w-1/2" src="/surat.png" alt="" />
    </a>
    <div class="p-5">
        <a href="{{ $href }}">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Hasil Pemeriksaan Audiometri</h5>
        </a>
...
<a href="{{ $href }}" class="block max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:bg-blue-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
