...
<body>
    ...
    <main>
        ...
        <x-lampiran-dan-tanggal noSurat="{{ $hepatia->noSurat }}" hal="Surat Keterangan Hasil Pemeriksaan Hepatitis A"
        ...
        <h3 style="margin-top: 0;">HASIL PEMERIKSAAN HEPATITIS A</h3>
        ...
        <table class="table-container-garis-tengah">
            <tr>
                ...
                <td style="text-align: justify;">Pemeriksaan Laboratorium Hepatitis A (HAV) :
                    @if ($hepatia->isHepatia)
            ...
            <tr>
                ...
                <td style="text-align: justify;">Pemeriksaan fisik dengan hasil saat ini <b>
                        ...
                        @endif
                    </b> tanda-tanda terinfeksi Hepatitis A.</td>
            </tr>
        </table>
        ...
        <p style="text-align: justify;">
            Surat Keterangan ini digunakan untuk : <b> {{ $hepatia->keperluanSurat }} </b>
        </p>
